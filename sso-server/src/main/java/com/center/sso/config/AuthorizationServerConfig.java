...
import com.center.sso.exception.OAuthServerAuthenticationEntryPoint;
import com.center.sso.exception.OAuthServerWebResponseExceptionTranslator;
import com.center.sso.filter.OAuthServerClientCredentialsTokenEndpointFilter;
...
//                .redirectUris("http://www.baidu.com");
    ...
    public AuthorizationServerTokenServices tokenServices() {
        ...
        //access_token的过期时间  60 * 60 * 24 * 2
        services.setAccessTokenValiditySeconds(60 * 60 * 12);
        //refresh_token的过期时间 60 * 60 * 24 * 7
...
//        return new InMemoryAuthorizationCodeServices();
    ...
    public void configure(AuthorizationServerEndpointsConfigurer endpoints) {
        ...
        tokenGranters.add(new JwtResourceOwnerPasswordToken(authenticationManager, tokenServices(), clientDetailsService,
